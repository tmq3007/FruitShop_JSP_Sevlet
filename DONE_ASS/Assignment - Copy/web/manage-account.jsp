                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary btn-sm edit" type="button" title="Edit" id="show-emp" data-toggle="modal"
                                                        data-target="#ModalUP${u.id}"><i class="fas fa-edit"></i>
                                                </button>
                                                <button class="btn btn-primary btn-sm trash" type="button" title="Delete" onclick="confirmDelete(${u.id})">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="exampleSelect1" class="control-label">Admin roll</label>
                    ...
                    dangerMode: true,
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                ...
                                window.location.href = "deleteaccount?cid=" + id;
                            }
                        });
            }
        </script>
