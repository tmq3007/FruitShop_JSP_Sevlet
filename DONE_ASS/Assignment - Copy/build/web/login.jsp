<%-- 
    Document   : login
    Created on : Jun 8, 2024, 12:08:53 AM
    Author     : admin
--%>
...
<html lang="en">
    ...
    <body>
        <div id="container" class="container">
            <!-- FORM SECTION -->
            <c:if test="${not empty requestScope.checkSignUp}">
                <c:if test="${requestScope.checkSignUp == true}">
                    <c:set var="checkSignUp" value="true" scope="request" />
                </c:if>
            </c:if>
            <div class="row">
                <!-- SIGN UP -->             
